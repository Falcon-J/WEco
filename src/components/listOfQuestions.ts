export const listOfQuestions = [
  ...
  {
    question:
      "Hierarchy emerges almost inevitably through a wide variety of evolutionary processes, for the simple reason that hierarchical structures are ___",
  ...
  {
    question: "In this food chain, hawk is a",
    options: [
      "producer",
  ...
  {
    question: "In this food chain, frog is a",
    options: [
      "producer",
      "consumer and carnivore",
      "consumer and herbivore",
  ...
  {
    question:
      "In this food chain, more grasshoppers than hawks can be supported",
    options: ["true", "false"],
    correct: 0,
    id: 38,
  },
  ...
  {
    question: "Compared to generalist species, specialist species have",
    options: [
      "narrower niches",
      "broader niches",
      "same-size niches",
  ...
  {
    question: "Fundamental niche is generally",
    options: [
  ...
  {
    question:
      "Growing vegetables under a teak plantation but the vegetable plants died out. This situation is an example of",
    options: ["autophagy", "allelopathy", "autopathy", "allelophagy"],
    correct: 1,
    id: 61,
  },
  {
  ...
  {
    question:
      "The rate of any biological process is limited by that factor in the least amount relative to requirement. This is the statement for",
    options: [
  ...
  {
    question:
      "The geographical distribution of a species will be controlled by the environmental factor for which the organism has the narrowest range of tolerance. This is the statement for",
    options: [
      "Liebig’s law of the minimum",
      "Liebig’s law of the maximum",
      "Shelford’s law of tolerance",
  ...
  {
    question:
      "Any changes in natural or human systems that inadvertently increase vulnerability to climatic stimuli is termed as",
  ...
  {
    question:
      "The government’s regulation to replace incandescent bulbs with LED bulbs to reduce carbon dioxide emissions is an example of",
  ...
  {
    question:
      "The ability of a system to adjust to climate change to moderate potential damages is defined as",
    options: [
      "adaptive response",
      "adaptive capacity",
      "mitigative response",
  ...
  {
    question:
      "Due to frequent droughts, the Mudumalai Tiger Reserve has built artificial water holes regularly filled by tankers. This action is an example of",
    options: ["adaptation", "mitigation", "deceleration", "maladaptation"],
    correct: 0,
    id: 100,
  },
  ...
  {
    question: "A pest population is considered controlled when",
    options: [
  ...
  {
    question:
      "Restoring a deciduous forest by filling a mine with soil and replanting species is an example of",
  ...
  {
    question: "The maximum sustainable yield is located near the",
    options: [
      "beginning of the sigmoidal curve",
      "mid-point of the sigmoidal curve",
      "end of the sigmoidal curve",
      "none of these",
    ],
    correct: 1,
    id: 108,
  ...
  {
    question:
      "Creating a lake visited by migratory birds by filling mine pits with water is an example of",
    options: ["recovery", "restoration", "enhancement", "replacement"],
    correct: 3,
    id: 110,
  },
  {
    question: "The book 'Enquiry into Plants' was written by",
    options: ["Theophrastus", "Linnaeus", "Malthus", "Humboldt"],
    correct: 0,
    id: 111,
  },
  ...
  {
    question:
      "Artificial water holes in the Mudumalai Tiger Reserve are an example of",
    options: ["adaptation", "mitigation", "deceleration", "maladaptation"],
    correct: 0,
    id: 118,
  },
